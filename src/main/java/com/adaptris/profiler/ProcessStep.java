...
public interface ProcessStep {
   ...
   *
   * @return the sequence number; note that this sequence number may be reset under high load and is not guaranteed to preserve the order.
   */
   ...
   *
   * @return the time taken; the difference between {@link System#currentTimeMillis()} and {@link #getTimeStartedMs()}
   */
